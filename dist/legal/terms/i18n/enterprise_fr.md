...
Client et qui collabore avec celui-ci pour les services liés à Odoo. Le
Client peut choisir à tout moment de travailler avec un autre Partenaire
Odoo, ou avec Odoo SA directement (moyennant préavis).
...
dans une base de données (par ex. avec Odoo Studio), pour ajouter des
fonctionnalités ou changer des comportements du Logiciel. Il peut avoir
été développé par le Client, par Odoo SA, par un Partenaire Odoo pour le
...
Bug à la discrétion d'Odoo SA (en général, lorsque le Logiciel ne
...
hébergée et entièrement gérée par Odoo SA, and accédée à distance par le
...
- Choix de plusieurs régions d'hébergement (minimum 3: Europe, Amérique,
  Asie/Pacifique)
...
- Prendre toutes les mesures raisonnables pour protéger les fichiers et
  ...
  sont en sûreté et sécurisées, en reconnaissant qu'Odoo SA ne peut être
...
- \(a\) Ne traiter les Données à Caractère Personnel que quand et comme
  ...
  Services du Contrat, à moins que la loi ne l'exige, auquel cas Odoo SA
...
- \(h\) Supprimer définitivement tout copie de la base de données du
  Client en possession d'Odoo SA, ou retourner ces données, au choix du
...
> of the terms of the “Odoo Enterprise Edition License” is the
...
[^1]: Les contributions externes sont couvertes par un [Copyright
    ...
    de copyright et de brevet permanente, gratuite et irrévocable à Odoo
    SA.
